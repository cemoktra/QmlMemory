...
.import "rng.js" as RandomImport
.import "presets.js" as PresetsImport
.import "helpers.js" as HelpersImport
.import "distances.js" as DistancesImport


 var presets = PresetsImport.presets;

var validateRgb = HelpersImport.validateRgb;
var labToRgb = HelpersImport.labToRgb;
var labToRgbHex = HelpersImport.labToRgbHex;
var labToHcl = HelpersImport.labToHcl;
var diffSort = HelpersImport.diffSort;
 ...
 */
function generatePalette(count, settings) {
   if (typeof count !== 'number' || count < 2)
     throw new Error('iwanthue: expecting a color count > 2.');

   settings = resolveAndValidateSettings(settings);

   var random = new RandomImport.Random(settings.seed)

   var rng = function() {
     return random.nextFloat();
   };

   var distances = new DistancesImport.CachedDistances();
